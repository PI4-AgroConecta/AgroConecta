...
const HoverMarker = ({ comercio }) => {
  ...
  const handleMarkerClick = () => {
    window.open(comercio.link, '_blank');  // Para abrir em uma nova guia
  };

  // Criando o ícone personalizado
  const customIcon = new L.Icon({
    iconUrl: comercio.imagem,  // Usando a imagem do comércio como ícone
    iconSize: [32, 32],         // Ajuste do tamanho do ícone
